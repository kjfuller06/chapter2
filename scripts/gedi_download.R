...
daterange=c("2019-01-01","2019-10-01")
...
outdir="data/gedi/richmond/tiny"
...
gedilevel1b<-readLevel1B(paste0(outdir, "\\GEDI01_B_2019253111453_O04217_T02086_02_003_01.h5"))
...
raster::shapefile(level1bGeo_spdf, paste0(outdir, "\\GEDI01_B_2019253111453_O04217_T02086_02_003_01_sub"))
...
# selecting only GEDI data with valid vegetation height data
level2AM = level2AM %>% 
  dplyr::filter(rh0 >= -213 & rh0 <= 213 & rh100 >= -213 & rh100 <= 213)
